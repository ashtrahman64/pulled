  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Crowd files on cheap colognes. Grades for pull, compliments, longevity, projection, and blind buys — explained so a kid could picture the smell.",
      },
        ...
        <AuthProvider>
          <QueryClientProvider client={queryClient}>
            ...
            <Toaster
              ...
              toastOptions={{
                className: "bg-raised text-fg shadow-border",
              }}
            />
          </QueryClientProvider>
        </AuthProvider>
